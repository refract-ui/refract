...
export const nativeElementPropDefinitions: NativeElementPropDefinitions = {
  ...
  pre: {
    link: 'https://html.spec.whatwg.org/multipage/semantics.html#the-pre-element',
    definition:
  ...
  figure: {
    link: 'https://html.spec.whatwg.org/multipage/semantics.html#the-figure-element',
    definition:
  ...
  legend: {
    link: 'https://html.spec.whatwg.org/multipage/forms.html#the-legend-element',
    definition:
      'The HTML <legend> element represents a caption for the content of its parent <fieldset>.'
  },
  ol: {
    link: 'https://html.spec.whatwg.org/multipage/semantics.html#the-ol-element',
    definition:
      'The HTML <ol> element represents an ordered list of items — typically rendered as a numbered list.'
  },
  ul: {
    link: 'https://html.spec.whatwg.org/multipage/semantics.html#the-ul-element',
    definition:
      'The HTML <ul> element represents an unordered list of items, typically rendered as a bulleted list.'
  },
  li: {
    link: 'https://html.spec.whatwg.org/multipage/semantics.html#the-li-element',
    definition:
  ...
  dt: {
    link: 'https://html.spec.whatwg.org/multipage/semantics.html#the-dt-element',
    definition:
  ...
  dd: {
    link: 'https://html.spec.whatwg.org/multipage/semantics.html#the-dd-element',
    definition:
      'The HTML <dd> element provides the description, definition, or value for the preceding term (<dt>) in a description list (<dl>).'
  },
  blockquote: {
    link: 'https://html.spec.whatwg.org/multipage/semantics.html#the-blockquote-element',
    definition:
  ...
  a: {
    link: 'https://w3c.github.io/webappsec-referrer-policy/#referrer-policy-delivery-referrer-attribute',
    definition:
  ...
  small: {
    link: 'https://html.spec.whatwg.org/multipage/semantics.html#the-small-element',
    definition:
  ...
  code: {
    link: 'https://html.spec.whatwg.org/multipage/semantics.html#the-code-element',
    definition:
